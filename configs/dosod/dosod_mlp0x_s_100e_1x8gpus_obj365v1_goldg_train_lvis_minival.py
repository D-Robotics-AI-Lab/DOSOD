...
num_text_joint_learning_layers = 0
...
model = dict(
    ...
    backbone_text=dict(
        ...
        model_name='/root/DOSOD/clip-vit-base-patch32',  # replace it with your own
        frozen_modules=['all']
    ),
...
obj365v1_train_dataset = dict(
    ...
    dataset=dict(
        ...
        data_root='/horizon-bucket/d-robotics-bucket/yonghao01.he/datasets/Objects365_v1/2019-08-02', # replace it with your own
...
mg_train_dataset = dict(type='YOLOv5MixedGroundingDataset',
                        data_root='/horizon-bucket/d-robotics-bucket/yonghao01.he/datasets/GQA', # replace it with your own
...
flickr_train_dataset = dict(
    ...
    data_root='/horizon-bucket/d-robotics-bucket/yonghao01.he/datasets/Flickr30k', # replace it with your own
...
coco_val_dataset = dict(
    ...
    dataset=dict(type='YOLOv5LVISV1Dataset',
                 data_root='data/coco/', # replace it with your own
                 test_mode=True,

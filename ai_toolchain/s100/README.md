## The Usage for building model on RDK S100 ai toolchain
...
```shell
cd /root/DOSOD/ai_toolchain/s100
...
python3 gen_calibration_data_s100.py
```
...
```shell
cd /root/DOSOD/ai_toolchain/s100
hb_compile --config con_DOSOD_L.yaml
```
...
Follow [hobot_dosod](https://github.com/D-Robotics/hobot_dosod) or [DOSOD Usage](https://developer.d-robotics.cc/rdk_doc/Robot_development/boxs/detection/hobot_dosod). Run on RDK S100/S100P board.

```shell
source /opt/tros/humble/setup.bash
ros2 launch hobot_dosod dosod.launch.py dosod_model_file_name:="config/dosod_mlp3x_l_rep-int16.hbm"
```
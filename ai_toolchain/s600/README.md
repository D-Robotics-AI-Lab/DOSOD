## The Usage for building model on RDK S600 ai toolchain
...
```shell
cd /root/DOSOD/ai_toolchain/s600
...
python3 gen_calibration_data_s600.py
```
...
Follow [hobot_dosod](https://github.com/D-Robotics/hobot_dosod) or [DOSOD Usage](https://developer.d-robotics.cc/rdk_doc/Robot_development/boxs/detection/hobot_dosod). Run on RDK S600 board.
